...
// Ideally, this would be generated by the backend, and sent to 
// generateShellScript. This would allow us to easily different commands for
// different platforms without affecting generateShellScript (it would also be
// necessary to allow the user to add/remove custom programs). However, since 
// this thing is a prototype, I don't see
// any need to do whatever contortions are necessary to make that happen.
// You'd only care about that kind of flexibility if you were writing this
// thing for prime time, in which case we wouldn't be using the HTML-5, CSS,
// Python, Javascript contortion that we're using here.
// --Andrew
var pgmCmdMap = {}
pgmCmdMap["Firefox"] = "firefox"
pgmCmdMap["Chrome"] = "google-chrome"
pgmCmdMap["Gedit"] = "gedit"
pgmCmdMap["GTKwave"] = "gtkwave"
pgmCmdMap["Adobe Reader"] = "acroread"
pgmCmdMap["Evince"] = "evince"
pgmCmdMap["Okular"] = "okular"
pgmCmdMap["Writer"] = "libreoffice --writer"
pgmCmdMap["Calc"] = "libreoffice --calc"
pgmCmdMap["Impress"] = "libreoffice --impress"
pgmCmdMap["Calculator"] = "gnome-calculator"
pgmCmdMap["Terminal"] = "gnome-terminal"
pgmCmdMap["Kile"] = "kile"
pgmCmdMap["TexWorks"] = "texworks"
pgmCmdMap["Sublime"] = "subl"
pgmCmdMap["gVim"] = "gvim -p"
pgmCmdMap["Emacs"] = "emacs"
pgmCmdMap["Eclipse"] = "eclipse"
pgmCmdMap["Gimp"] = "gimp"
pgmCmdMap["Image Viewer"] = "eog"
pgmCmdMap["RhythmBox"] = "rhythmbox"
pgmCmdMap["VLC"] = "vlc"
...
var generateShellScript = function(pad) {
    ...
    for (var i=0; i < pad.contents.length; i++){
        ...
        for (var j=0; j < programFiles.length; j++){
            fileString = fileString.concat(" ", programFiles[j]);
        }
        if (pgmCmdMap.hasOwnProperty(programName)){
            scriptText = scriptText.concat("( { ", pgmCmdMap[programName],  
                    fileString, " ; } ) &\n");
        }
        else{
            throw(programName.concat( "does not exist in pgmCmdMap."));
        }
    }
    return scriptText
};
